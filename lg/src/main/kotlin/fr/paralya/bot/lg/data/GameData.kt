...
data class GameData(
	 ...
	 * @return A new GameData instance with state set to DAY and dayCount incremented.
	 */
	 ...
	 * @return A new GameData instance with state set to NIGHT and nightCount incremented.
	 */
	 ...
	 * @return A new GameData instance with the interview added to the interviews list.
	 */
	 ...
	 * @return A new GameData instance with the specified interview removed from the interviews list.
	 */
